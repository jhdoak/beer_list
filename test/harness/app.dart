...
export 'package:beer_list/beer_list.dart';
export 'package:aqueduct/test.dart';
export 'package:test/test.dart';
export 'package:aqueduct/aqueduct.dart';

/// A testing harness for beer_list.
///
/// Use instances of this class to start/stop the test beer_list server. Use [client] to execute
/// requests against the test server.  This instance will use configuration values
/// from config.src.yaml.
class TestApplication {
  Application<BeerListSink> application;
  BeerListSink get sink => application.mainIsolateSink;
  TestClient client;
